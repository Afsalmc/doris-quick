...
# Default version
DORIS_QUICK_START_VERSION="2.1.10"
...
services:
  fe:
    ...
    environment:
      ...
      - FE_ID=1
    volumes:
      - /home/afsal/development/doris/mysql-connector-java-8.0.25.jar:/opt/apache-doris/fe/jdbc_drivers/mysql-connector-java-8.0.25.jar
      - /home/afsal/development/doris/mssql-jdbc-12.10.1.jre8.jar:/opt/apache-doris/fe/jdbc_drivers/mssql-jdbc-12.10.1.jre8.jar
    network_mode: host
  be:
    ...
    volumes:
      - /home/afsal/development/doris/mysql-connector-java-8.0.25.jar:/opt/apache-doris/be/jdbc_drivers/mysql-connector-java-8.0.25.jar
      - /home/afsal/development/doris/mssql-jdbc-12.10.1.jre8.jar:/opt/apache-doris/be/jdbc_drivers/mssql-jdbc-12.10.1.jre8.jar
    depends_on:
      - fe
    network_mode: host
  mssql:
